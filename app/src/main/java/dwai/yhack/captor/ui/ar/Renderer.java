package dwai.yhack.captor.ui.ar;

import static dwai.yhack.captor.ui.ar.GLUtils.checkGLError;
...
public class Renderer implements CardboardView.StereoRenderer {
    ...
    /**
     * Check if user is looking dwai object by calculating where the object is in eye-space.
     * @return
     */
